            ...
            foreach (var customer in customers)
            {
                ...
                foreach (var order in customer.Orders)
                {
                    ...
                    foreach (var item in order.Items)
                    {
                        ...
                        //in {item.Id,6} here 6 means we want this to take up 6 spaces if it is shorter it will align to the right and 
                    ...
                    //print row of dashes and number 110 means the dashes will be centered in space that is 110 characters means space wide means dashes will be centered nice
                    Console.WriteLine($"\n{"-------------------",110}");
                    ...
                    //ensures that there is enough space for the total order cost to right aligned after it
